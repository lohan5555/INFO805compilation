...
Voici une proposition d'intégration pour ton fichier `README.md`. J'ai ajouté une section **"Architecture et Fonctionnement de l'AST"** juste avant les commandes de compilation. Elle explique simplement et de manière structurée comment tes classes Java interagissent avec CUP.

Voici le code complet de ton nouveau README :
...
Une fois l'arbre généré, récupérez le dans le programme principal et affichez le, par exemple sous la forme d'une expression préfixée parenthésée :
`(; (LET prixTtc (/ (* prixHt 119) 100)) (+ prixTtc 100))`
